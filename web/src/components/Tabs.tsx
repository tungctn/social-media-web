    ...
    <div>
      <div className="flex flex-row justify-around border-b-[1px] border-black">
        {tabItems.map((tabItem, index) => {
          return (
            <button
              className={`3xl:text-2xl text-xl 3xl:pt-[30px] pt-[calc(30px/6*5)] flex flex-col transition-all duration-300 after:content-[''] after:w-0 after:h-[3px] after:translate-y-[1.5px] after:transition-all after:duration-300${
