...
export default function FriendRequireCard({ friend }: FriendRequireCardProps) {
  return (
    <div className="bg-white flex flex-col justify-between 3xl:py-8 py-6 3xl:px-[46px] px-8 rounded-[20px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] 3xl:w-[266px] 3xl:h-[328px] w-[calc(266px/6*5)] h-[calc(328px/6*5)]">
